...
function evaluate() {
  ...
  function _evaluate(path) {
    ...
    if (path.isTemplateLiteral()) {
      ...
      for (var _iterator = node.quasis, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref;
    ...
    if (path.isArrayExpression()) {
      ...
      for (var _iterator2 = elems, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        var _ref2;
    ...
    if (path.isCallExpression()) {
      ...
      if (callee.isMemberExpression()) {
        ...
        if (_object.isLiteral() && _property.isIdentifier()) {
          var _type = _typeof(_object.node.value);
