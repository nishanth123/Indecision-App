        ...
        exit: function exit(path) {
          ...
          for (var _iterator2 = body, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
            ...
            if (_path.isExportDeclaration()) {
              ...
              for (var _iterator4 = _specifiers, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
                var _ref4;
            ...
            if (_path.isImportDeclaration()) {
              ...
              if (_declaration.node) {
                if (_declaration.isFunctionDeclaration()) {
                  ...
                  for (var _iterator5 = declarators, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
                    var _ref5;
              ...
              if (_source) {
                ...
                for (var _iterator6 = _specifiers2, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
                  var _ref6;
          ...
          for (var source in imports) {
            ...
            if (specifiers.length) {
              ...
              for (var _iterator3 = specifiers, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
                var _ref3;
